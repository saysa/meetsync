...
| 12 | ✅ DONE | should allow a timeslot to be created when it starts exactly at the building's opening time |
| 13 | ✅ DONE | should allow a timeslot to be created when it ends exactly at the building's closing time |
