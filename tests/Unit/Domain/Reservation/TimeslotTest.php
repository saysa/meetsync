...
final class TimeslotTest extends TestCase
{
    ...
    #[Test]
    public function should_prevent_creation_when_end_falls_after_buildings_closing_time(): void
    {
        $this->expectException(InvalidTimeslotException::class);
    ...
    #[Test]
    public function should_allow_creation_when_start_is_exactly_at_buildings_opening_time(): void
    {
        $timeslot = new Timeslot(
            start: new DateTimeImmutable('2026-03-09 08:00:00'),
            end: new DateTimeImmutable('2026-03-09 09:00:00'),
            openingTime: new DateTimeImmutable('2026-03-09 08:00:00'),
            closingTime: new DateTimeImmutable('2026-03-09 19:00:00'),
        );
        ...
        self::assertSame(
            new DateTimeImmutable('2026-03-09 08:00:00')->getTimestamp(),
            $timeslot->start->getTimestamp(),
        );
    }
